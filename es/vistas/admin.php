          ...
          <div class="clearfix hidden-xs text-center hide" id="aside-user">
            <div class="dropdown wrapper">
              ...
              <ul class="dropdown-menu animated fadeInRight w hidden-folded">
               ...
               <li><a onclick="abrirModalusuario()" data-toggle="modal">Actualizacion de contraseña</a></li>
                <li class="divider"></li>
                <li>
                  <a href="../controlador/usuario/controlador_usuario_cerrar_sesion.php">Salir</a>
                </li>
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="mimodal_registrar"><label>Actualizacion de contraseña</label></h4>
        </div>
        <div class="modal-body">
