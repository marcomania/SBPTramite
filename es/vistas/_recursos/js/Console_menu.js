...
function filtrar_DocumentosPendientes(){
	...
	.done(function(resp){
		...
		if (data.length > 0) {
            ...
            cadena+="<li class='wrapper bg-light' style='padding: 4px 0px; margin-top: -9px;margin-bottom: -5px;' onclick="+"cargar_contenido('main-content','Verificar_documento/vista_verificardocumento_listar.php');"+"><a><h6 class='p-3mb-0 text-center'><strong> "+con+" Documento Pendiente</strong></h6></a></li>";           	
            }
