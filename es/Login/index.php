			...
			<div class="sub-main-w3">				
				...
				<div class="form-style-agile">
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" placeholder="Ingrese su usuario" id="txt_usuario" required>
					</div>
				</div>
				<div class="form-style-agile">
					...
					<div class="input-group mb-3">
						...
						<input type="password" class="form-control" placeholder="Ingrese su Password" aria-label="Password" id="txt_pass" required>
					</div>
				</div>
				<center><a href="seguimiento.php" class="btn btn-default" style="box-shadow: 0 0 0 .2rem rgba(0,0,0,0);">Seguimiento Documentario</a><br><br></center>
