...
<html lang="zxx">
<head>
	<title>Documentary Monitoring</title>
...
<body>
	<div style="text-align: center;" class="row">
		<div class="col-md-12" style="text-align: center;">
			<br><br>
			<label>FOLLOW-UP PROCESS</label><br><br>
		</div>
		<div class="col-md-4">
		</div>
		<div class="col-md-4">
		...
		<div class="col-md-1">
			<button  class="btn btn-primary" onclick="buscardocumento()"><i class=" fa fa-plus-square-o"></i>&nbsp;SEARCH</button>  <br><br>
		</div>	
	</div>
	<div class="main-w3ls">
		                ...
		                <thead>
		                    <tr>
		                        <th style = 'text-align: center;width: 80px;word-wrap: break-word;font-weight: bold;'>ID</th>
            								<th style = 'text-align: center;width: 50px;word-wrap: break-word;font-weight: bold;'>SUBJECT</th>
            								<th style = 'text-align: center;width: 130px;word-wrap: break-word;font-weight: bold;'>RECEPTION DATE</th>
            								<th style = 'text-align: center;width: 150px;word-wrap: break-word;font-weight: bold;'>ASSIGNED AREA</th>
            								<th style = 'text-align: center;width: 150px;word-wrap: break-word;font-weight: bold;'>DOCUMENT TYPE</th>
            								<th style = 'text-align: center;width: 40px;word-wrap: break-word;font-weight: bold;'>SENDER</th>
                            <th style = 'text-align: center;width: 20px;word-wrap: break-word;font-weight: bold;'>ARCHIVE</th>
            								<th style = 'text-align: center;width: 30px;word-wrap: break-word;font-weight: bold;'>STATE</th>
		                    </tr>
		                </thead>
	...
	<div class="input-group mb-12 col-md-12" style="text-align: right;">
		<a href="index.php" class="btn btn-default" style="box-shadow: 0 0 0 .2rem rgba(0,0,0,0);">Return to login</a><br><br>
	</div>
	</div>
<style type="text/css">
	label{
