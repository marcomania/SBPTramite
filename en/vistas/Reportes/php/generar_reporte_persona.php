...
INNER JOIN area ON documento.area_cod = area.area_cod order by documento_cod";
	...
	$pdf->Cell(70);
	$pdf->Cell(120,10, 'Sender paperwork report',0,0,'C');
	$pdf->Ln(30);
	$pdf->SetFont('Courier','B',12);
	$pdf->SetFillColor(232,232,232);
	$pdf->SetFont('Courier','B',10);
	$pdf->Cell(25,6,utf8_decode('CODE'),1,0,'C',1);
	$pdf->Cell(80,6,utf8_decode('SENDER'),1,0,'C',1);
	$pdf->Cell(101,6,'SUBJECT',1,0,'C',1);
	$pdf->Cell(35,6,utf8_decode('RECEPTION DATE'),1,0,'C',1);
