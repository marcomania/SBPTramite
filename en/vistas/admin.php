...
<head>
  <meta charset="utf-8" />
  <title>Documentary System | Panel</title>
    ...
    <div class="app-header navbar">
      <div class="navbar-header bg-dark">
        ...
        <a href="admin.php" class="navbar-brand text-lt">
          ...
          <span class="hidden-folded m-l-xs">Proc. System</span>
        </a>
      </div>
        ...
        <div class="nav navbar-nav hidden-xs">
          ...
          <a href class="btn no-shadow navbar-btn" data-toggle="class:show" data-target="#aside-user">
			...
			<li class="dropdown" >
				...
				<ul class="dropdown-menu animated fadeInRight w" style="width:100px">
				  <li >

				  <a href="../../es/vistas/admin.php">Spanish</a>
				  <a href="../../en/vistas/admin.php">English</a>
				  </li>
				</ul>
			</li>
			</ul>
            ...
            <ul class="dropdown-menu animated fadeInRight w hidden-folded" style="width:250px" >
			  ...
			  <li ui-sref-active="active">
				<a  onclick="abrirmodaladministrativo()">
					<span class="badge bg-danger pull-right">D</span>
					<span>Personal Data</span>
				</a>
              </li>
              <li class="divider"></li>
              <li>
                <a href="../controlador/usuario/controlador_usuario_cerrar_sesion.php">Exit</a>
              </li>
            </ul>
          </li>
        </ul>
          ...
          <div class="clearfix hidden-xs text-center hide" id="aside-user">
            <div class="dropdown wrapper">
              ...
              <ul class="dropdown-menu animated fadeInRight w hidden-folded">
                ...
                <li><a onclick="abrirmodaladministrativo()">Personal information</a>
                </li>
               <li><a onclick="abrirModalusuario()" data-toggle="modal">Account settings</a></li>
                <li class="divider"></li>
                <li>
                  <a href="../controlador/usuario/controlador_usuario_cerrar_sesion.php">Exit</a>
                </li>
          ...
          <nav ui-nav class="navi">
            <ul class="nav">
              <li class="hidden-folded padder m-t m-b-sm text-muted text-xs">
                <span translate="aside.nav.HEADER">ADMINISTRATIVE PANEL</span>
              </li>
            <?php if ($_SESSION['usu']=="ADMINISTRADOR") {        
            ?>
              <li>
                <a href class="auto">      
                  ...
                  <span class="font-bold" translate="aside.nav.Mantenimiento">STAFF</span>
                </a>
            ...
            ?>
              <li>
                <a href class="auto">      
                  ...
                  <span class="font-bold" translate="aside.nav.Mantenimiento">SENDER</span>
                </a>
                <ul class="nav nav-sub dk">
              ...
              <li>
                <a href class="auto">      
                  ...
                  <span class="font-bold" translate="aside.nav.Mantenimiento">INSTITUTION</span>
                </a>
                <ul class="nav nav-sub dk">
              ...
              <li ui-sref-active="active">
                <a ui-sref="app.mail.list">
                  ...
                  <span class="font-bold" translate="aside.nav.Venta">DOCUMENT</span>
                </a>
               <ul class="nav nav-sub dk">
                  <li ui-sref-active="active">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
         <div class="modal-header">
           ...
           <h4 class="modal-title" id="myModalLabel"><label> EDIT PERSONAL DATA</label></h4>
         </div>
              ...
              <div class="panel-body">
                <form method="POST" id="update-form-administrador">
                  <div class="col-md-6">
                    ...
                    <label  class="col-sm-4 control-label">Names </label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" onkeypress="return soloLetras(event)" name="nombres_personal" id="nombres_personal" placeholder="Enter Names" maxlength="">
                      <br>
                    </div>
                    <label  class="col-sm-4 control-label">Last name </label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control"onkeypress="return soloLetras(event)"  name="apePate_personal" id="apePate_personal" placeholder="Enter Paternal Last Name" maxlength="">
                      <br>
                    </div>
                    <label  class="col-sm-4 control-label">Mother's last name </label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" onkeypress="return soloLetras(event)" name="apeMate_personal" id="apeMate_personal" placeholder="Enter Maternal Name" maxlength="">
                      <br>
                    </div> 
                  </div>
                  <div class="col-md-6">
                    <div class="col-sm-12" style="text-align:center">
                      <label  class="control-label">Photography</label><br>
                      <div id="txtimagen2">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-sm-4">
                      <input type="email" class="form-control"  style="width: 94%"  name="email_personal" id="email_personal" placeholder="Enter email" maxlength="100">
                      <br>
                    </div> 
                    <label  class="col-sm-2 control-label">Telephone </label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" onkeypress="return soloNumeros(event)"  name="telefono_personal" id="telefono_personal" placeholder="Enter phone number" maxlength="9">
                      <br>
                    </div> 

                    <label  class="col-sm-2 control-label">Mobile </label>
                    <div class="col-sm-4">
                      <input type="text" style="width: 94%" class="form-control" name="movil_personal" id="movil_personal"  onkeypress="return soloNumeros(event)" placeholder="Enter number mobile" maxlength="9">
                      <br>
                    </div> 
                    <label  class="col-sm-2 control-label">Direction </label>
                    <div class="col-sm-4">
                      <input type="text"  class="form-control"  onkeypress="return soloLetras(event)" name="direccion_personal" id="direccion_personal" placeholder="Enter direction" maxlength="200">
                      <br>
                    </div> 
                    ...
                    <div class="col-sm-4">
                      <input type="text"  class="form-control"  onkeypress="return soloNumeros(event)" name="dni_personal" id="dni_personal" placeholder="Enter DNI" maxlength="13">
                      <br>
                    </div> 
                  </div>
                  <div class="col-md-12 col-lg-12 col-xs-12" style="text-align:center;" >
                    ...
                    <div class="col-md-4" >
                       <button class="btn btn-success"  style="width: 100%" ><span class="glyphicon glyphicon-floppy-saved" ></span>&nbsp;<b>Modify data</b></button><br>
                    </div>
                    <div class="col-md-4">
                    </div>
                  </div>
    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="mimodal_registrar"><label>Update Password</label></h4>
        </div>
        <div class="modal-body">
          <form class="form-horizontal" id="formulario_usuario">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" style="background:#fff;font-weight:bold;" value="<?php echo $_SESSION['usu'] ?>" disabled="" id="tipo_usuario" placeholder="User Type" maxlength="40">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    ...
                    <input type="text"  style="background:#fff;font-weight:bold;" id="txtusuario" class="form-control" value="<?php echo $_SESSION['usuario'] ?>" disabled=""  placeholder="User" maxlength="30">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label"> Current</label>
                  <div class="col-sm-5">
                    <input type="password" class="form-control"  id="txtactual" placeholder="Current password" maxlength="30">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">New </label>
                  <div class="col-sm-5">
                    <input type="password" class="form-control"  id="txtnueva" placeholder="New password" maxlength="30">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-4 control-label">Repeat New Password</label>
                  <div class="col-sm-5">
                    <input type="password" class="form-control" id="txtrepetir" placeholder="repeat new password" maxlength="30">
                  </div>
              ...
              <div class="box-footer text-center">
                <button type="button" style="cursor:pointer;" onclick="Editar_cuenta();" class="btn btn-success"><b>Update </b>&nbsp;&nbsp; <i class="fa fa-floppy-o fa-lg" aria-hidden="true"></i> </button>
              </div>
              <!-- /.box-footer -->
            </form>  
        </div>
      ...
      $.ajax({  
        ...
        success:function(resp) {
          ...
          if(resp>0){
            ...
            swal("Sorry the data was not recorded","","error")
            .then ( ( value ) =>  { 
              document.getElementById("update-form-administrador").reset();
              traer_administrador();
            } ) ;
