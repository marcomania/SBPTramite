	...
	$.ajax({
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<th style = 'text-align: center'>AREA</th>";
				cadena += "<th style = 'text-align: center'>REGISTRATION DATE</th>";
				...
				if(pagina>1){
					...
					paginar += "<li><a href='javascript:void(0)' onclick='listar_area_vista("+'"'+valor+'","'+(pagina-1)+'"'+")'>Previous</a></li>";
				}
				else{
				...
				if(pagina < numero_paginas){
					paginar += "<li><a href='javascript:void(0)' onclick='listar_area_vista("+'"'+valor+'","'+(pagina+1)+'"'+")'>Next</a></li>";
...
function Editar_area(){
	...
	.done(function(resp){
		if (resp > 0) {
			...
			swal("! Sorry, the area was previously registered!", "", "error");	
		}
	})
