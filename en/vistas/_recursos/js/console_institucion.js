		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				if(pagina>1){
					...
					paginar += "<li><a href='javascript:void(0)' onclick='listar_institucion_vista("+'"'+valor+'","'+(pagina-1)+'"'+")'>Previous</a></li>";
				}
				else{
				...
				if(pagina < numero_paginas){
					paginar += "<li><a href='javascript:void(0)' onclick='listar_institucion_vista("+'"'+valor+'","'+(pagina+1)+'"'+")'>Next</a></li>";
...
function Editar_institucion(){
	...
	.done(function(resp){
		if (resp > 0) {
			...
			swal("! We are sorry, the institution has already been registered previously!", "", "error");	
		}
	})
