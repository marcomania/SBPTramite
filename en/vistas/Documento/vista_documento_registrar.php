...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
       <label><h2><b>REGISTER DOCUMENTS</b></h2></label>
    </div>
        ...
        <form method="POST" id="create-form-documento">
          <div class="form-group">
            ...
            <div class="col-md-6">
              ...
              <label>Subject</label>
              <textarea class="form-control" rows="5"  style="resize: none" style="color: rgb(25,25,51); background-color: rgb(255,255,255);solid 5px;" placeholder="Enter Subject ..." id="txtasunto_documento" name="asunto"></textarea>
            </div> 
          </div>
          <div class="form-group">
            <div class="col-sm-6">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4"><br><label>&nbsp;</label>
              <a role="button" class="btn btn-primary col-sm-12" style="width: 100%"  onClick="AbrirModalRemitente()"><i class="fa fa-search"></i> <b>Select Sender</b></a>
              <br> 
            </div>
            <div class="col-sm-12">
              <div class="form-group"><br>
                ...
                <div class="input-group col-sm-12" style="width: 94%">
                  ...
                  <span class="input-group-append">
                    <button class="file-upload-browse btn btn-info" type="button"><strong>Load</strong></button>
                  </span>
                </div>
              </div>
            </div> 
          ...
          <div class="form-group">
            <div class="col-md-12" style="text-align: center;"><br>
              <br><button class="btn btn-success" onclick="Registrar_documento_post()"><strong> Register Document</strong></button><br><br>
            </div>
          </div>
        </form>
    </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
         <div class="modal-header">
           ...
           <h4 class="modal-title" id="myModalLabel"><b>Available Senders</b></h4>
         </div>
               ...
               <div class="box-body">
                  <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs pull-right">
                      <li class="active"><a href="#tab_1-1" data-toggle="tab"><strong> SENDERS </strong>  </a></li>
                      <li><a href="#tab_2-2" data-toggle="tab"><strong> INSTITUTIONS</strong></a></li>
                    </ul>
                    <div class="tab-content" style="width: 100%">
                      <div class="tab-pane active" id="tab_1-1"><BR><BR>
                        <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sender's DNI :</label>
                        <br>
                        <div class="col-md-12"> 
                          <div class=" input-group">
                            <input type="text" class="form-control" placeholder="Enter the sender's DNI to search" id="txtbuscar_dniremitente" onkeypress="return soloNumeros(event)">
                      ...
                      <div class="tab-pane" id="tab_2-2"><br><br>
                        ...
                        <div class="col-md-12"> 
                          <div class=" input-group">
                            <input type="text" class="form-control" placeholder="Enter name of the institution to search" id="txtbuscar_institucionremiten" onkeypress="return soloLetras(event)">
                            <span class="input-group-addon"><i class="fa fa-search"></i></span>
                          </div>
                          <br>
                        </div>
