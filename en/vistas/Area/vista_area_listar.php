...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
        <h2><b>REGISTERED AREAS</b></h2>
    </div>
    <div class="panel-body">
        <div class="col-md-10"> 
          <div class=" input-group">
            <input id="txt_area_vista" type="text" class="form-control" onkeypress="return soloLetras(event)"  placeholder="Enter the name of the area to search ">
            <span class="input-group-addon"><i class="fa fa-search"></i></span>
          </div>
        </div>
        <div class="col-md-2">
          <button class="btn btn-danger" onclick="cargar_contenido('main-content','Area/vista_area_registrar.php');"><i class="fa fa-file-text" ></i> &nbsp;&nbsp;<strong>New Registration</strong></button>    
        </div>
        <div class="col-md-12">
          <div class="box-body table-responsive" style="text-align: center;"><br>
          	<label>AREAS LIST</label>
