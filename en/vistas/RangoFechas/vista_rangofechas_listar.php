...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
        <h2><b>DOCUMENT REPORT - RANGE DATES</b></h2>
    </div>
        ...
        <br><br>
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-4" style="text-align: center;"><br><br>
              ...
              <button id="btn-imprimir" name="btn-imprimir" style="width:100%" type="submit" class="btn btn-danger"><i class='glyphicon glyphicon-print'></i>&nbsp;&nbsp;<strong>PRINT REPORT</strong></button>  
              </form>
            </div>
          </div>
