...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h2><b>TYPE OF REGISTERED DOCUMENTS</b></h2>            
    </div>
    <div class="panel-body">
      <br>
      <div class="col-md-10"> 
        <div class=" input-group">
          <input type="text" class="form-control" placeholder="Enter name type of document to search" id="txtbuscar_tipodocumento"  onkeypress="return soloLetras(event)"  >
          <span class="input-group-addon"><i class="fa fa-search"></i></span>
        </div>
      </div>
      <div class="col-md-2">
        <button style="width:100%" class="btn btn-danger" onclick="cargar_contenido('main-content','Tipo_Documento/vista_tipoDocumento_Registrar.php')"><i class="fa fa-plus-square"></i>&nbsp;<b>New Registration</b></button>   
      </div>
      <div class="col-md-12">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
         <div class="modal-header">
           ...
           <h4 class="modal-title" id="myModalLabel"><b>Edit Document Type</b></h4>
         </div>
        <div class="modal-body">
                ...
                <div class="col-md-6 ">
                  ...
                  <select id="cbmEstado" class="form-control select2" style="width: 100%">
                    ...
                    <option value="INACTIVO">NOT AVAILABLE</option>
                  </select>
                </div>
              <div class="col-md-12 col-lg-12 col-xs-12" style="text-align:center;" >
                <br>
                <button class="btn btn-success" onClick="Editar_TipoDocumento()"><i class="fa fa-check"></i>&nbsp;<b>Modify Document Type</b></button>
              </div>
              <br>           			
            </div>
        </div>
