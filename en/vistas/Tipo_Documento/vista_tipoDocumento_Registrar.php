...
<div class="contendor_kn">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h2><b>DOCUMENT TYPE REGISTRATION</b></h2>
			<br>
		</div>
		<div class="panel-body">
            ...
            <div class="col-md-12">
                <label>Name</label>
                <input type="text" id="txttipodocumento_modal" placeholder="Enter the name or description of the document type" onkeypress="return soloLetras(event)" style="background-color: #FFFFFF" class="form-control"><br>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-12 col-lg-12 col-xs-12" style="text-align:center;" >
                <br><br>
                <button class="btn btn-success" onClick="Registrar_TipoDocumento()"><i class="fa fa-floppy-o"></i>&nbsp;<b>Register Document Type</b></button>
            </div>
            <br>           			
        </div>
        <br>
